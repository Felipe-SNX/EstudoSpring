...
public class UsuarioIT {
    ...
    @Test
    public void listarUsuarios_ComoAdmin_RetornarListaDeUsuariosComStatus200() {
    ...
    @Test
    public void listarUsuarios_ComoUsuarioSemPermissao_RetornarErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/usuarios")
                .headers(JWTAuthentication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
